...
import CharTable.CharacterAtributs;
...
public class HuffmanTree {
    ...
    public HuffmanTree(CharTable charTable) {
        ...
        for (CharacterAtributs character : charTable.charList) {
            ...
            nodeController.setFrequency(character.getFrequency());
        ...
        if(heapMin.sizeList > 1) {
            while(heapMin.sizeList > 1) {
                ...
                Node single = heapMin.remove();
    
                Node tree = new Node();
    
                tree.setCharacter("-");
                tree.setFrequency(single.getFrequency());
